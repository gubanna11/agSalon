...
namespace agSalon.Domain.Migrations
{
    ...
    [Migration("20230411104205_schedules")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("agSalon.Domain.Entities.Schedule", b =>
                {
                    b.Property<string>("WorkerId")
                        .HasColumnType("varchar(255)")
                        .HasColumnName("worker_id");
            ...
            modelBuilder.Entity("agSalon.Domain.Entities.ServiceGroup", b =>
                {
                    b.Property<int>("ServiceId")
                        .HasColumnType("int")
                        .HasColumnName("service_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("agSalon.Domain.Entities.Client", null)
                        .WithMany()
            ...
            modelBuilder.Entity("agSalon.Domain.Entities.ServiceGroup", b =>
                {
                    ...
                    b.HasOne("agSalon.Domain.Entities.Service", "Service")
                        ...
                        .HasForeignKey("agSalon.Domain.Entities.ServiceGroup", "ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
